...
max_ui_session_budget: Optional[float] = 100  # $100 USD budgets for UI Chat sessions
max_ui_session_budget_duration: Optional[str] = "7d"
max_ui_session_rpm: Optional[int] = 100
